...
ModelWindow_GL_3_3::ModelWindow_GL_3_3(QString filepath, ModelLoader::PathType pathType, QString texturePath) :
...
void ModelWindow_GL_3_3::initializeGL()
{
...
void ModelWindow_GL_3_3::createShaderProgram(QString vShader, QString fShader)
{
...
void ModelWindow_GL_3_3::createBuffers()
{
    if(m_error)
        return;
...
void ModelWindow_GL_3_3::createAttributes()
{
    if(m_error)
        return;
...
void ModelWindow_GL_3_3::setupLightingAndMatrices()
{
...
void ModelWindow_GL_3_3::resizeGL(int w, int h)
{
    glViewport( 0, 0, w, h );
...
void ModelWindow_GL_3_3::paintGL()
{
    if(m_error)
        return;
...
void ModelWindow_GL_3_3::drawNode(const Node *node, QMatrix4x4 objectMatrix)
{
    // Prepare matrices
...
void ModelWindow_GL_3_3::setMaterialUniforms(MaterialInfo &mater)
{
...
void ModelWindow_GL_3_3::cleanupGL()
{
}
