...
class Viewport_GL_3_3 : public QOpenGLFunctions_3_3_Core, public Viewport
{
  using Viewport::Viewport;//forward constructor args
public:
  Viewport_GL_3_3(QString filepath, ModelLoader::PathType pathType, QString texturePath = "");
