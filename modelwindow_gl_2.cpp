...
ModelWindow_GL_2::ModelWindow_GL_2(QString filepath, ModelLoader::PathType pathType, QString texturePath, QWidget *parent) :
...
void ModelWindow_GL_2::initializeGL()
{
...
void ModelWindow_GL_2::createShaderProgram(QString vShader, QString fShader)
{
...
void ModelWindow_GL_2::createBuffers()
{
    if(m_error)
        return;
...
void ModelWindow_GL_2::createAttributes()
{
    if(m_error)
        return;
...
void ModelWindow_GL_2::setupLightingAndMatrices()
{
...
void ModelWindow_GL_2::resizeGL(int w, int h)
{
    glViewport( 0, 0, w, h );
...
void ModelWindow_GL_2::drawNode(const Node *node, QMatrix4x4 objectMatrix)
{
    // Prepare matrices
...
void ModelWindow_GL_2::setMaterialUniforms(MaterialInfo &mater)
{
...
void ModelWindow_GL_2::cleanupGL()
{
}
