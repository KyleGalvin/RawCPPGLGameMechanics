...
class ModelWindow_GL_2 : public QOpenGLFunctions, public ModelWindow
{
    using ModelWindow::ModelWindow;//forward constructor args
    //Q_OBJECT
public:
    ModelWindow_GL_2(QString filepath, ModelLoader::PathType pathType, QString texturePath="", QWidget *parent=0);
